...
def DrawTrainLoss(loss):
    plt.plot(loss)
    plt.savefig("TrainLoss_cnnpretrain.png")
    plt.close()
...
def ParseInput():
    ...
    _parser.add_argument("--epoch", default = 250, help = "Epoch", type=int)
...
if __name__ == '__main__':
    # logging.basicConfig(level=logging.INFO, filename="pretraincnnLog.log", filemode='w', format=FORMAT)
